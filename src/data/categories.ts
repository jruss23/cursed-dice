...
export const SPECIAL_CATEGORIES: readonly CategoryConfig[] = [
  ...
  },
  {
    ...
    name: 'All Odd',
    shortName: 'All Odd',
    description: 'All dice are 1, 3, or 5',
    section: 'special',
    calculate: (dice) => (dice.every((d) => d % 2 === 1) ? sumAll(dice) : 0),
  },
  {
    id: 'allEven',
    name: 'All Even',
    shortName: 'All Even',
    description: 'All dice are 2, 4, or 6',
    section: 'special',
    calculate: (dice) => (dice.every((d) => d % 2 === 0) ? sumAll(dice) : 0),
  },
  {
    id: 'allHigh',
    name: 'All High',
    shortName: 'All High',
    description: 'All dice are 4, 5, or 6',
    section: 'special',
    calculate: (dice) => (dice.every((d) => d >= 4) ? sumAll(dice) : 0),
  },
] as const;

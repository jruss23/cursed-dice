...
export const BLESSING_CONFIGS: Record<BlessingId, BlessingConfig> = {
  ...
  mercy: {
    ...
    description: 'Once per seal, reset your hand completely: new dice, full rerolls.',
    icon: '🕊️',
    benefits: [
  ...
  sanctuary: {
    ...
    description: 'Save your current dice, then restore them later when you need them. 1 use per seal.',
    icon: '🛡️',
    benefits: [
  ...
  sixth: {
    ...
    subtitle: 'Extra Die',
    description: 'Add a 6th die to your roll, but only the best 5 count for scoring. 3 uses per seal.',
    icon: '🎲',
    benefits: [
      'Roll 6 dice instead of 5',
      'Keep the best 5 for scoring',
      '3 charges per seal, resets each round',
    ],

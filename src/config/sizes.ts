...
export const SIZES = {
  ...
  // Shared panel styling (CSS pixels, will be scaled by toDPR)
  PANEL_CORNER_SIZE: 12,
  PANEL_CORNER_INSET: 5,
  PANEL_GLOW_SIZE: 12,
